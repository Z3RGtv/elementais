...
function renderizarGridColecao(player, targetGridId, isSelectionMode, selectCallback) {
    ...
    if (spanAgua) {
        if (hasAllWater) {
            ...
            if (labelAgua) labelAgua.style.color = "#ffd700";
        } else {
            spanAgua.textContent = "40%";
            spanAgua.style.color = "";
            spanAgua.style.fontWeight = "";
            if (labelAgua) labelAgua.style.color = "";
        }
    }
